" Vim color file - javier
" Generated by http://bytefluent.com/vivify 2013-01-22
set background=dark
if version > 580
	hi clear
	if exists("syntax_on")
...
hi Identifier guifg=#409090 guibg=NONE guisp=NONE gui=NONE ctermfg=66 ctermbg=NONE cterm=NONE
...
hi LineNr guifg=#545863 guibg=#151617 guisp=#151617 gui=NONE ctermfg=241 ctermbg=233 cterm=NONE
hi StatusLine guifg=#b9b9b9 guibg=#3e3e5e guisp=#3e3e5e gui=NONE ctermfg=250 ctermbg=60 cterm=NONE
hi Normal guifg=#b5b5b5 guibg=#202229 guisp=#202229 gui=NONE ctermfg=249 ctermbg=235 cterm=NONE
...
hi Statement guifg=#67759c guibg=NONE guisp=NONE gui=NONE ctermfg=60 ctermbg=NONE cterm=NONE
...
hi Function guifg=#67759e guibg=NONE guisp=NONE gui=NONE ctermfg=60 ctermbg=NONE cterm=NONE
...
hi Keyword guifg=#ed7979 guibg=NONE guisp=NONE gui=NONE ctermfg=210 ctermbg=NONE cterm=NONE
...
hi String guifg=#bf9885 guibg=NONE guisp=NONE gui=NONE ctermfg=138 ctermbg=NONE cterm=NONE
